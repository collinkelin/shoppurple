...
class Script extends Controller
{
    ...
    //         $content = minify_compress($content);
    //         return $content;
    //     });
    // }
...
\$(function () {
    ...
    \$.copyToClipboard = function (content, input) {
        ...
        document.body.appendChild(input), input.select(), setTimeout(function () {
            document.execCommand('Copy') ? \$.msg.tips('{$lang('Copy successfully')}') : \$.msg.tips('{$lang('Copy failed')}');
    ...
    document.addEventListener('error', function (e, elem) {
        ...
        if (elem.tagName.toLowerCase() === 'img') {
            elem.src = '/static/theme/img/404_icon.png';
        }
    }, true);
