...
</style></head><body><header><a class="back" href="javascript:history.go(-1);"><i class="fa fa-chevron-left" aria-hidden="true"></i></a><span><?php echo lang('Change transaction password'); ?></span><a class="back" href="/"><i class="fa fa-home" aria-hidden="true"></i></a></header><section><div class="container"><div class="form"><p class="form_title"><?php echo lang('Login password safe'); ?>:</p><div class="input_box"><input type="password" placeholder="<?php echo lang('Please enter a password safe'); ?>" id="old"></div></div><div class="form"><p class="form_title"><?php echo lang('New password safe'); ?>:</p><div class="input_box"><input type="password" placeholder="<?php echo lang('Please enter a new password safe'); ?>" id="new"></div></div><div class="form"><p class="form_title"><?php echo lang('Confirm password safe'); ?>:</p><div class="input_box"><input type="password" placeholder="<?php echo lang('Enter new password again safe'); ?>" id="again"></div></div><div class="btn"><?php echo lang('confirm'); ?></div></div></section><script src="https://cdn.jsdelivr.net/npm/jquery@3.4.1/dist/jquery.min.js" type="text/javascript"></script><script src="https://cdn.jsdelivr.net/npm/chlayer@3.1.5/dist/mobile/layer.js"></script><script src="https://cdn.jsdelivr.net/npm/dot@1.1.3/doT.min.js"type="text/javascript" ></script><script src="https://cdn.jsdelivr.net/npm/cleave.js@1.5.10/dist/cleave.min.js" type="text/javascript"></script><script src="https://cdn.jsdelivr.net/npm/clipboard@2.0.6/dist/clipboard.min.js" type="text/javascript"></script><script src="/public/js/ui.js?v=1595490271"></script><script src="/public/js/common.min.js?v=1595490271"></script><script src="/public/js/city.js"></script><script src="/public/js/picker.min.js"></script><script>
var submit = true
...
$('.btn').click(function() {
    ...
    if (old_pwd == "") {
        ...
        QS_toast.show(`<?php echo lang('Confirm password'); ?>`, true)
