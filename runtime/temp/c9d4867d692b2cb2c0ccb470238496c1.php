<?php /*a:1:{s:67:"/www/wwwroot/www.oabuhps.cn/application/index/view/my/add_bank.html";i:1595490352;}*/ ?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="ie=edge"><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" name="viewport" /><title><?php echo lang('Add bank card'); ?></title><script src="https://cdn.jsdelivr.net/npm/jquery@3.4.1/dist/jquery.min.js" type="text/javascript"></script><link rel="stylesheet" href="/public/css/style.min.css?v=1595490870"><script src="/public/js/ui.js?v=1595490870"></script><link rel="stylesheet" href="/public/css/ui.min.css?v=1595490870"><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css"><script src="/public/js/common.min.js?v=1595490870"></script><style>
        .form_container {
        ...
        if (submit) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    console.log(res);
                    if (res.code == 0) {
                        QS_toast.show(`<?php echo lang('Added successfully'); ?>`, true);
