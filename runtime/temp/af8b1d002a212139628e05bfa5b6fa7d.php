<?php /*a:3:{s:66:"/www/wwwroot/www.oabuhps.cn/application/index/view/index/home.html";i:1595483807;s:60:"/www/wwwroot/www.oabuhps.cn/application/index/view/main.html";i:1593514237;s:68:"/www/wwwroot/www.oabuhps.cn/application/index/view/public/floor.html";i:1595435444;}*/ ?>
<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="Robots" content="noindex,nofollow"><meta http-equiv="X-UA-Compatible" content="ie=edge"><meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;" name="viewport" /><title><?php echo sysconf('site_name'); ?></title><link rel="stylesheet" type="text/css" href="/public/css/style.min.css?v=1595492187"><link rel="stylesheet" type="text/css" href="/public/css/ui.min.css?v=1595492187"><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/chlayer@3.1.5/dist/mobile/need/layer.css"><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome.min.css"><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/swiper@3.1.7/dist/css/swiper.min.css"><link rel="stylesheet" type="text/css" href="/res/common/css/hui.min.css?v=1595492187"><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/yaseng/jquery.barrager.js@master/dist/css/barrager.css"><style type="text/css">
* {
    margin: 0;
    padding: 0;
...
.ggnotice {
    ...
    position: relative;
    background: #5534AA;
    background-image: linear-gradient(to top,#9677EC,#5534AA);
    border-radius: 4%;
    color: #fff;
}
.ggnotice p{
...
/*Home Project Statistics*/
</style></head><body><header><span><?php echo sysconf('site_name'); ?></span></header><section style="padding-bottom: 30px;"><div style="background:#ffffff;"><div class="pop-background flex" id="myModal" style="top: -4000px;"><div class="ggnotice flex fw" style="max-height:300px"><img src="/public/new_img/tc.png" class="ggnotice-img" style="height:100%;width:102%;max-width: 102%;max-height: 100%;max-height:100px;margin-left:-5px"><div class="ggnotice-html"><p style="margin-left:0cm; margin-right:0cm; text-align:center"><span style="font-size:12pt"><span style="font-family:宋体;color:#fff"><strong><span style="font-size:13.5pt"><span class="modelTitle" style="font-family:宋体;color:#fff"><?php echo htmlentities($notice['title']); ?></span></span></strong></span></span></p><p class="content"><?php echo strip_tags($notice['content']); ?></p><p><a class="page_index_ckxxnr" style="color:#fff" href="/index/support/detail/6.html?id=6"><?php echo lang('View details'); ?></a></p></div><img src="/res/common/images/close_notice.png" class="close-img"></div></div><div class="hui-wrap"><div class="container" style="margin-top:0px;padding-bottom: 5px;height: 140px;"><div class="swiper-container "><div class="swiper-wrapper "><?php if($banner): if(is_array($banner) || $banner instanceof \think\Collection || $banner instanceof \think\Paginator): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide"><a href="<?php echo htmlentities($vo['url']); ?>"><img src="<?php echo htmlentities($vo['image']); ?>" alt=""></a></div><?php endforeach; endif; else: echo "" ;endif; else: ?><?php endif; ?></div><div class="swiper-pagination"></div></div></div><style>
            .news_gg_icon{
                width:45px; 
                height:45px;
                position: relative;
        ...
        </style><!--公告--><div style="background:#EEEEEE; padding:0px 10px; margin:15px;border-radius:25px 25px 25px 25px;height:35px;" class="hui-flex"><div style="height:75px; width:75px; margin-top:-30px; margin-left:-20px;"><img class="news_gg_icon" src="/public/new_img/gg_icon.png" /></div><div class="hui-scroll-news" id="scrollnew1"><?php if(is_array($conveys) || $conveys instanceof \think\Collection || $conveys instanceof \think\Paginator): $i = 0; $__LIST__ = $conveys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hui-scroll-news-items" style="color:#777"><?php echo htmlentities($vo['con']); ?></div><?php endforeach; endif; else: echo "" ;endif; ?></div></div><!--公告结束--><!--个人信息--><div class="index_my_infos"><div class="index_my_infos_item"><p><?php echo lang('Profit'); ?></p><?php echo htmlentities(formatNumber($sell_y_num)); ?></div><div class="index_my_infos_item"><p><?php echo lang('Balance'); ?></p><?php echo htmlentities(formatNumber($userinfo['balance'])); ?></div><div class="index_my_infos_item"><p><?php echo lang('Freeze'); ?></p><?php echo htmlentities(formatNumber($userinfo['freeze_balance'])); ?></div><div class="index_my_infos_item" style="padding-top:4px"><a href="<?php echo url('recharge/recharge_before'); ?>"><div class="index_my_infos_btns"><?php echo lang('Recharge'); ?></div></a><a href="<?php echo url('ctrl/deposit_before'); ?>"><div class="index_my_infos_btns"><?php echo lang('Withdraw'); ?></div></a></div></div><!--个人信息end--><div class="containera" style=" width:90%; height:115px;margin:0 auto;padding:.5rem 0;margin-bottom:0px"><div style="width:100%; height:50px; display: flex;" class="row"><div style="width:50%;height:100%; "><div style="color:#fff; text-align:center;font-size:15px; " ><?php echo lang('Todays products'); ?></div><div style=" text-align:center;" ><span id="taskCounta" style="color:#fff; font-size:17px;    margin-top:3px;display:block">99</span></div></div><div style="width:50%;height:100%; "><div style="color:#fff; text-align:center;font-size:15px; " ><?php echo lang('Todays users'); ?></div><div style=" text-align:center;" ><span id="memberCount" style="color:#fff; font-size:17px;margin-top:3px;display:block">99</span></div></div></div><div style="width:100%; height:50px; display: flex;" class="row"><div style="width:50%;height:100%; "><div style="color:#fff; text-align:center;font-size:15px; " ><?php echo lang('Todays amount'); ?></div><div style=" text-align:center;" ><span id="moneyCount" style="color:#fff; font-size:17px;margin-top:3px;display:block">99</span></div></div><div style="width:50%;height:100%; "><div style="color:#fff; text-align:center;font-size:15px; " ><?php echo lang('Todays turnover'); ?></div><div style=" text-align:center;" ><span id="applyCount" style="color:#fff; font-size:17px;margin-top:3px;display:block">99</span></div></div></div></div><div class="new_goodlist"><?php foreach($cate as $key=>$vo): ?><a  class="goQiangDan" data-id="1" data-price="<?php echo htmlentities($balance); ?>" data-min="<?php echo htmlentities($vo['min']); ?>" onclick="return hoto(this)" href="<?php echo url('rot_order/index',array('type'=>1)); ?>?type=<?php echo htmlentities($vo['id']); ?>"><div class="new_goodlist_item"><div class="goods_image"><img src="<?php echo htmlentities($vo['cate_pic']); ?>" /></div><div class="goodlist_title"><?php echo htmlentities($vo['name']); ?><p style="color:#fff;font-size:.6rem"><?php echo lang('Commission'); ?>:<?php echo htmlentities($vo['bili']*100); ?>%</p></div><div class="good_info_item"><?php echo htmlentities($vo['cate_info']); ?></div></div></a><?php endforeach; ?></div></div></div></section><script src="https://cdn.jsdelivr.net/npm/jquery@3.4.1/dist/jquery.min.js" type="text/javascript"></script><script src="https://cdn.jsdelivr.net/npm/chlayer@3.1.5/dist/mobile/layer.js"></script><script src="https://cdn.jsdelivr.net/npm/dot@1.1.3/doT.min.js"type="text/javascript" ></script><script src="https://cdn.jsdelivr.net/npm/cleave.js@1.5.10/dist/cleave.min.js" type="text/javascript"></script><script src="https://cdn.jsdelivr.net/npm/clipboard@2.0.6/dist/clipboard.min.js" type="text/javascript"></script><script src="/public/js/ui.js?v=1595492187"></script><script src="/public/js/common.min.js?v=1595492187"></script><script src="/public/js/city.js"></script><script src="/public/js/picker.min.js"></script><script src="https://cdn.jsdelivr.net/gh/yaseng/jquery.barrager.js@master/dist/js/jquery.barrager.min.js"></script><script src="https://cdn.jsdelivr.net/gh/shenhai/HUI@master/js/hui.js" type="text/javascript" charset="utf-8"></script><script src="https://cdn.jsdelivr.net/npm/swiper@3.1.7/dist/js/swiper.min.js"></script><style>
@font-face {
...
$(function() {
    ...
    tips();
    setInterval(function() { tips(); }, 5000);
})
var tid = 0;
...
function tips() {
    $.get("<?php echo url('tip'); ?>", function(result) {
        if (result.data) {
            if (tid != result.data.id) {
                tid = result.data.id;
                layer.open({
                    // anim: 'up',
                    title: [result.data.title,'background-color: #FF4351; color:#fff;'],
                    content: result.data.content,
                    btn: [`<?php echo lang('confirm'); ?>`],
                    shadeClose: false,
                    yes: function(index) {
                        if (result.data.url)
...
function getTonji() {
    $.getJSON("/index/Index/getTongji", function(data) {
        console.log(data)
        $('#taskCounta').html(data.data.goods)
...
function hoto(obj) {
    ...
    if (price < min) {
        alert("<?php echo lang('Insufficient balance to enter the rush order'); ?>");
        return false;
    }
}
</script><script>
